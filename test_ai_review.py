...
# Test with 3 very different repos
repos = [
    "scikit-learn/scikit-learn",      # High quality, popular ML library
    "torvalds/linux",                  # Massive kernel project
    "octocat/Hello-World",             # Minimal example repo (low quality signal)
]
